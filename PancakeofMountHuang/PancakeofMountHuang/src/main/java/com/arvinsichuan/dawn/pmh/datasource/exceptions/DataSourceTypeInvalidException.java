 ...
 * Package: com.arvinsichuan.dawn.pmh.datasource.exceptions
 */
public class DataSourceTypeInvalidException extends Exception {

    public DataSourceTypeInvalidException(String message) {
        super("Invalid datasource type" + message);
    }
